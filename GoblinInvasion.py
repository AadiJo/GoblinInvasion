...
class player(object):
    ...
    Hearts = [pygame.image.load(resource_path('Game\Hearts1.png')),
              pygame.image.load(resource_path('Game\Hearts2.png')),
              pygame.image.load(resource_path('Game\Hearts3.png')),
              pygame.image.load(resource_path('Game\Hearts4.png')),
              pygame.image.load(resource_path('Game\Hearts5.png')),
              pygame.image.load(resource_path('Game\Hearts6.png')),
              pygame.image.load(resource_path('Game\Hearts7.png')),
              pygame.image.load(resource_path('Game\Hearts8.png')),
              pygame.image.load(resource_path('Game\Hearts9.png')),
    ...
    def draw(self, window):
        if not powerUP:
            if self.alive:
                if not pause:
                    window.blit(pygame.transform.scale(self.Hearts[self.heartCount], (170, 110)),
                                (self.heartX, self.heartY))
...
while True:
    ...
    while run:
        ...
        if hits != 0 and not pause:
            timeIs = (timeUp - timer)
            # print(str(round(timeUp - timer)) + " - " + str(round(float(pausetimeUp))) + " = " + str(round(timeIs) - round(float(pausetimeUp))))
